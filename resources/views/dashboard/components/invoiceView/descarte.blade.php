...
<div class="modal-body" wire:key="InvoiceDescarte">
    <div wire:loading.grid wire:target="procesarDescarte" wire:key="loadingInvoiceDescarte">
    ...
    <div wire:loading.remove wire:target="procesarDescarte" wire:key="formInvoiceDescarte">
        <div class="row">
            <div class="col-12">
                <h4>Clave de autorizacion de descarte</h4>
                <hr/>
            </div>
...
<div class="modal-footer" wire:key="InvoiceDescarteFooter">
    <button wire:click="procesarDescarte" class="btn btn-primary" wire:key="InvoiceDescarteBtn" wire:target="procesarDescarte,claveSupervisor" wire:loading.attr="disabled">
