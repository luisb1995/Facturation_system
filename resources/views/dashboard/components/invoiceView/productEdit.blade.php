<div class="modal-header" style="background-color:#5063df;color:white;">
    <h4 class="modal-title" id="exampleModalLabel">
       Modificando producto: {{ $descriptionEdit }}
    </h4>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon1"  wire:key="formEditProductQuantity" style="background-color:#727CF5;color:white;"><i class="mdi mdi-format-align-justify"></i></span>
                        </div>
                    <input type="text" class="form-control" wire:model.debounce.200ms='quantityEdit'>

                    </div>
                    @error('quantityEdit') <span style="color:red;font-weight:bold;"><i class="uil uil-times-circle"></i> {{ $message }}</span> @enderror
                </div>
            </div>
...
<div class="modal-footer">
    <button wire:click="detailUpdate" class="btn btn-primary" wire:key="clientInvoiceRegisterBtn" wire:target="detailUpdate,quantityEdit" wire:loading.attr="disabled">
